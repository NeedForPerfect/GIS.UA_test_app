...
export const ApiGetSupplierDetailSuccess = createAction(API_GET_SUPPLIER_DETAIL_SUCCESS, props<{id: string}>());
...
export const ApiEditSupplierSuccess = createAction(API_EDIT_SUPPLIER_SUCCESS, props<{ id: string, supplier: Supplier }>());

export const ApiDeleteSupplier = createAction(API_DELETE_SUPPLIER, props<{ id: string }>());
export const ApiDeleteSupplierSuccess = createAction(API_DELETE_SUPPLIER_SUCCESS, props<{ id: string }>());
